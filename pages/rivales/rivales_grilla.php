<div class="flex flex-col bg-light-gray-bg justify-center items-center rounded-3xl p-8 gap-10">
    ...
    <main class="w-full grid lg:grid-cols-5 md:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-4 justify-center" id="grilla-container">
        ...
        <!-- <div class="rivales-item-drag bg-green rounded-md flex flex-col justify-center items-center p-1 gap-1" draggable="true"
            ...
            <div>
                <img src="assets/imgs/drag-black.png" class="w-6" alt="">
            </div>
        </div> -->

        <!-- Repite más items si lo deseas -->
    </main>
</div>
