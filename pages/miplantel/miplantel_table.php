<table id="miplantel-table" class="styles-table w-full row-border overflow-" style="width:100%">
    <thead class="bg-black text-white hover:!bg-black thead-dark">
        <!-- Seleccionar todas las filas btn -->
        <tr>
            <th id="" scope="col">
                <div class="flex justify-between items-center ">
                    <button id="selectAllRowsButton"
                    ...
                    <button id="deleteSelectedRowsButton" class="hidden bg-gray-bg/0">
                        <span class="">
            ...
            <th scope="col" ></th> <!-- foto y edad col -->
            <th scope="col">Nombre del jugador</th>
            <th scope="col" class="text-white">Posicion</th>
